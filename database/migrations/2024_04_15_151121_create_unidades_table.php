...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('produtos', function (Blueprint $table){
            ...
            $table->foreign('unidade_id')->references('id')->on('unidades'); // corrigido para 'unidades'
        });
    ...
    Schema::table('produto_detalhes', function (Blueprint $table){
        $table->dropForeign('produto_detalhes_unidade_id_foreign'); // para exclusão c[nome da tabela, id, foreign]
